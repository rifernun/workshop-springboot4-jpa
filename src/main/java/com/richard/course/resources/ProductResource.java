...
import com.richard.course.services.ProductService;
...
public class ProductResource {
    ...
    public ResponseEntity<Product> findById(@PathVariable Long id) {
        Product obj = service.findById(id); //pega da classe service onde vai estar todos os tipos de execucoes e buscas
